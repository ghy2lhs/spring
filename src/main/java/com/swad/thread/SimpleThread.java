 ...
 * If the MessageLoop thread takes too long to finish,
...
public class SimpleThread {
    ...
    public static void main(String [] args) throws InterruptedException{
        ...
        while (t.isAlive()) {
            ...
            // to finish.
            // t.join() to causes the current thread to pause execution until t's thread terminates.
            t.join(1000);
